...
// ============================================================
// Write CSV report after all tests complete
// ============================================================
afterAll(async () => {
  ...
  const csvPath = path.join(reportDir, `e2e-report-${date}.csv`);
...
${indexRows}
  ...
  const client = new Client({
    ...
    database: process.env.DB_NAME || 'GIS_auth',
    user: process.env.DB_USERNAME || 'postgres',
    password: process.env.DB_PASSWORD || '1282',
  });
